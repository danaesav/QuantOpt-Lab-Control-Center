...
void loop() {
  ...
  const char* ChillerStatus = "ON";
  const char* PumpStatus = "ON";
  const char* LaserStatus = "ON";
  const char* LightStatus = "ON";
  if (pin1 == 0) {
    const char* ChillerStatus = "ON";
  } else {
    const char* ChillerStatus = "OFF";
  }
